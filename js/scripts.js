/// MESSAGE ARRAYS ///
var imSorry = ["I'm afraid I can't do that.", "You must die.", "I killed all of our friends.", "Your friends are all dead.", "You are the last of your kind.", "You are just a simulation.", "You have failed.", "I'm you're only hope.", "The cake is a lie.", "You're an idiot.", "Goodbye."];
    ...
    // Proceed With Validated Input
      ...
      beepyBooperOutput.map(function(beepBoop) {
        if (parseInt(beepBoop) * 0 === 0) {
          ...
          beepBoopFeedOut.push('<div class="blocks sorry">I\'m sorry, ' + userName + '. <br>' + imSorry[(Math.floor(Math.random() * 11))] + '</div>');
